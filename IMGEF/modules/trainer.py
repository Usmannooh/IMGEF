...
class BaseTrainer(object):
    def __init__(self, model, forward_adj, backward_adj, criterion, criterion_c, metric_ftns, optimizer, args,
        ...
        file_handler = logging.FileHandler('training_log_imgef.txt')
...
# print Log In CSV
    ...
    # Select the best training to save
...
class Trainer(BaseTrainer):
    def __init__(self, model, forward_adj, backward_adj, criterion, criterion_c, metric_ftns, optimizer, args,
                 lr_scheduler, train_dataloader, val_dataloader, test_dataloader):  #criterion,
        super(Trainer, self).__init__(model, forward_adj, backward_adj, criterion, criterion_c, metric_ftns, optimizer,
                                      args, lr_scheduler)  #criterion,
    ...
    def _train_epoch(self, epoch):
        ...
        for batch_idx, (images_id, images, reports_ids, reports_masks) in enumerate(self.train_dataloader):
            ...
            loss = 0.2 * self.criterion(output, reports_ids, reports_masks) + 0.8 * self.criterion_c(output) #0.2*0.8
